...
import { Search, X, ExternalLink, Users, PlaySquare, Calendar, Eye } from 'lucide-react'
        ...
        {!query && (
          <div className="mt-4 text-center space-y-2">
            <p className="text-lg font-medium">
              It's easy to add a new channels, just start typing the name of the channel you want to add.
            </p>
